...
<p>
A large language model (LLM) inference interface that allows for the use of various local and remote LLMs. Models and servers can be switched on the fly without losing conversational context.
</p>
...
- 💼 **Commercial License:**  
  For closed-source or commercial use, you must reach out to inferyn.contact@proton.me
